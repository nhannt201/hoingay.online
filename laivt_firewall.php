...
function baoloi($msg,$time=60)
{
	echo "
	<html>
	<head><title>Luutru360.com-Firewall System</title>
...
echo "			</div><br />
		...
		<div align='center' style='border:1px solid #EEE; padding:5px 0px 5px 5px; color:#808080; font-face:Tahoma;'>Firewall 360 1.0 by <a href='http://luutru360.com/'>Luutru360.Com</a> &copy; ".date('Y')." </div>";
if ($time!=-1)
	echo "<script> 
 var milisec=0 
 var seconds=$time 
