...
if (isset($_POST['dangnhap']))
{
	...
	$content= "Xin chào, <br> Mật khẩu của bạn là : <br> <font color='red'>".$row['password']."</font><br/>Chúng tôi đã gửi mật khẩu cho bạn <br> Truy cập vào http://".$_SERVER['HTTP_HOST']".ref-mail để đăng nhập!";
